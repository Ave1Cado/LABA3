...
namespace Lab3DS.bibliotekaDataSetTableAdapters {
    ...
    public partial class AuthorsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Lab3DS.Properties.Settings.Default.bibliotekaConnectionString;
        }
...
SELECT Book_ID, Title, Author_ID, Genre_ID, Year FROM Books WHERE (Book_ID = @Book_ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT Books.Book_ID, Books.Title, Books.Author_ID, Authors.Name\r\nFROM  Books INN" +
                "ER JOIN\r\n         Authors ON Books.Book_ID = Authors.Author_ID";
        ...
        public virtual int FillBy(bibliotekaDataSet.BooksDataTable dataTable) {
        ...
        public virtual bibliotekaDataSet.BooksDataTable GetDataBy() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            bibliotekaDataSet.BooksDataTable dataTable = new bibliotekaDataSet.BooksDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
